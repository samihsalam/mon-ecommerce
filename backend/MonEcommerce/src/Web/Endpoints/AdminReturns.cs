...
public class AdminReturns : IEndpointGroup
{
    ...
    public static void Map(RouteGroupBuilder groupBuilder)
    {
        ...
        groupBuilder.MapPatch(UpdateStatus, "{returnId:guid}").RequireAuthorization();
    ...
    public static async Task<IResult> UpdateStatus(Guid returnId, [FromBody] UpdateReturnStatusRequest request, ISender sender)
    {
